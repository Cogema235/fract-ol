...
int update_render(t_fractol* fractol)
{
    ...
    pthread_create(&hl,NULL, renderhl, fractol);
    pthread_create(&ll,NULL, renderll, fractol);
    pthread_create(&hr,NULL, renderhr, fractol);
    pthread_create(&lr,NULL, renderlr, fractol);
